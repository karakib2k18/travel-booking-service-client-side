            ...
            <div className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 lg:w-2/6 mx-auto">
                <div className="max-w-md w-full space-y-8">
                    <div>
                        ...
                        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Add a New Tourist Place</h2>
                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="rounded-md shadow-sm -space-y-px">
                            <div>
                                ...
                                />
                                {errors.title && <span className="text-red-500 text-sm italic">Title is required </span>}
                            </div>
                        </div>
                        <div className="rounded-md shadow-sm -space-y-px">
                            <div>
                        ...
                        <div className="rounded-md shadow-sm -space-y-px">
                            <div>
                                ...
                                />
                                {errors.countrydestination && <span className="text-red-500 text-sm italic">Country-Destination is required </span>}
                            </div>
                        </div>
                        <div className="rounded-md shadow-sm -space-y-px">
                            <div>
                                ...
                                />
                                {errors.price && <span className="text-red-500 text-sm italic">Price is required </span>}
                            </div>
                        </div>
                        <div className="rounded-md shadow-sm -space-y-px">
                            <div>
                                ...
                                />
                                {errors.location && <span className="text-red-500 text-sm italic">Place location is required </span>}
                            </div>
                        </div>
                        <div className="rounded-md shadow-sm -space-y-px">
                            <div>
                                ...
                                />
                                {errors.groupsize && <span className="text-red-500 text-sm italic">Group Size is required </span>}
                            </div>
                        </div>
                        <div className="rounded-md shadow-sm -space-y-px">
                            <div>
